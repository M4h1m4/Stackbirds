...
1. An extracted invoice (vendor, line items with unit prices).
...
If at any step you are not confident, return clarification_questions. You may ask clarifying questions as needed (e.g. "Is vendor X the same as approved vendor Y?", "Which contracted row should line item Z map to?").
...
"""
    ...
    if obj.get("clarification_questions"):
